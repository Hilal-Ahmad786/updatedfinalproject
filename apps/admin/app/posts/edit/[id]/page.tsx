// apps/admin/app/posts/edit/[id]/page.tsx - Updated with Rich Text Editor
'use client'
...
import { BlogContentBlocks } from '@/components/blog-content-blocks'
import { 
  ArrowLeftIcon, 
  SaveIcon, 
  SendIcon,
...
<AdvancedRichTextEditor
  value={post.content}
  onChange={handleContentChange}
  placeholder="Write your blog post with advanced formatting..."
